...
footer{border-top:1px solid var(--line);padding:30px 0;color:var(--muted);font-size:13.5px}
"""
...
{CART_JS}
{body}
<footer><div class="wrap" style="display:flex;justify-content:space-between;flex-wrap:wrap;gap:10px;padding:0">
<div>© 2026 OCBuyBack · Brea, CA</div>
<div>{" · ".join(f'<a href="{u}" target="_blank" rel="noopener">{n}</a>' for n, u in SOCIAL)}</div>
<div><a href="{p}privacy-policy/index.html">Privacy</a> · <a href="{p}terms-of-service/index.html">Terms</a> · <a href="{p}faq/index.html">FAQ</a> · <a href="{p}contact-us/index.html">Contact</a></div></div></footer>
